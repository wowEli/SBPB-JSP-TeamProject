...
<body data-aos-easing="slide" data-aos-duration="800" data-aos-delay="0">
		...
		<div class="container">
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-9 text-center mt-5">
					<h1 class="heading aos-init aos-animate" data-aos="fade-up">회원 정보</h1>

					<nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="200" class="aos-init aos-animate">
						<ol class="breadcrumb text-center justify-content-center">
							<li class="breadcrumb-item "><a href="main.do">Home</a></li>
							<li class="breadcrumb-item active text-white-50" aria-current="page">회원 정보</li>
						</ol>
					</nav>
				</div>
			</div>
					...
					<input type="hidden" name="action" value="#">
						...
						<hr>
							<div class="col-12 mb-3">
								<p>아이디</p>
								<input type="email" id="userid" name="mid" class="form-control" value="${mid }" readonly>
							</div>
							<div class="col-12 mb-3">
								<p>비밀번호 (*)</p>
								<input type="password" id="userpasswd" name="mpw" class="form-control" value="${mData.mpw }" >
							</div>
							<div class="col-12 mb-3">
								<p>비밀번호 확인 (*)</p>
							...
							<div class="col-12 mb-3">
								<p>이름</p>
								<input type="text" id="username" name="mname" class="form-control" value="${mData.mname }" maxlength="5" readonly>
							</div>
							<div class="col-12 mb-3">
                        ...
                        <input type="tel" name="mphone" id="phone" class="form-control" value="${mData.mphone }" maxlength="11" readonly style="width: 255px; margin-left: 12px; margin-right:10px;"/>
								<br><br><br><br>
								<p>주소 (*)</p>
								<input type="text" name="mpostcode" id="sample2_postcode" class="form-control" value="${mData.mpostcode }" readonly style="width: 120px; margin-left: 12px; margin-right:10px;">
							...
							<div class="col-12 mb-3">
								<input type="text" name="maddress" id="sample2_address" class="form-control" value="${mData.maddress }" readonly>
								<input type="text" name="mdetailaddress" id="sample2_detailAddress"class="form-control"  value="${mData.mdetailaddress }">
								<input type="text" name="mextraaddress" id="sample2_extraAddress" class="form-control "value="${mData.mextraaddress }" readonly>
							</div>

							<div class="col-12">
								<input type="button" value="정보변경" id="updateM" class="btn btn-primary" onclick="update()">
								<input type="button" value="회원탈퇴" id="deleteM" class="btn btn-primary" onclick="del()" style="background-color:red;">
							</div>
	...
	function update(){
			...
			// 변경해줄 button 타겟
			var bt = document.getElementById('updateM'); 
	...
	function del(){
		...
		if(ans == true){
			...
			// 변경해줄 button 타겟
			var bt = document.getElementById('deleteM'); 
