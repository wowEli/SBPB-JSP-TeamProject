				...
				<div class="col-lg-9 text-center mt-5">
					...
					<nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="200" class="aos-init aos-animate">
						<ol class="breadcrumb text-center justify-content-center">
							...
							<li class="breadcrumb-item active text-white-50" aria-current="page">일반 회원가입</li>
						</ol>
					</nav>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
					<form action="mInsert.do" method="post" name="signUp" id="sign-up">
							<!-- 수정 : aciton값을 회원가입.do로 원하는 로직으로 바꾸시오 -->
						<div class="row">
						<h2>계정 생성</h2></br>
						<hr>
							<div class="col-12 mb-3">
								<p>아이디</p>
								<input type="email" id="userid" name="mid" class="form-control"  onchange="idCheck()" placeholder="이메일 주소 입력" required>
								<div id="result"></div>
							</div>
							<div class="col-12 mb-3">
								<p>비밀번호</p>
								<input type="password" id="userpasswd" name="mpw" class="form-control" placeholder="8자리 이상 입력" >
							</div>
							<div class="col-12 mb-3">
								<p>비밀번호 확인</p>
							...
							<div class="col-12 mb-3">
								<p>이름</p>
								<input type="text" id="username" name="mname" class="form-control" placeholder="이름 입력" maxlength="5">
							</div>
							<div class="col-12 mb-3">
						...
						<input type="tel" name="mphone" id="phone" class="form-control" placeholder="12345678"  maxlength="8" style="width: 498px; margin-left: 12px; margin-right:10px;"/>
<!-- 						<a href="javascript:sms();">인증번호 전송</a> -->
						<input type="button" onclick="sms()" value="인증번호 전송"  style="width: 120px; border:white; height: 42px; text-align: center; background-color:#2ac1bc; color:white; margin-left: 10px;">
						<div id="result1"></div>
						<br>
						<input type="tel" name="checkNum" id="checkNum" maxlength="6" class="form-control" style="width: 700px; margin-left: 12px; margin-right:10px;"/>
<!-- 						<a href="javascript:smsCheck();">인증번호 확인</a> -->
						<input type="button" onclick="smsCheck()" value="인증번호 확인"  style="width: 120px; border:white; height: 42px; text-align: center; background-color:#2ac1bc; color:white; margin-left: 10px;">
						<div id="result2"></div>
						
								<p style="margin-top: 12px;">주소</p>
								<input type="text" name="mpostcode" id="sample2_postcode" class="form-control" placeholder="우편번호" readonly style="width: 120px; margin-left: 12px; margin-right:10px;">
							...
							<div class="col-12 mb-3">
								<input type="text" name="maddress" id="sample2_address" class="form-control" placeholder="주소" readonly>
								<input type="text" name="mdetailaddress" id="sample2_detailAddress"class="form-control"  placeholder="상세주소">
								<input type="text" name="mextraaddress" id="sample2_extraAddress" class="form-control" placeholder="참고항목" readonly>
							</div>
